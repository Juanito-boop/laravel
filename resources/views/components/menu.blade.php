<div id="menu"
  ...
  <ul class="pt-auto flex w-[80%] flex-col gap-3">
    <li
      class="px-auto block cursor-pointer rounded-xl py-[20px] text-[25px] text-[white]
      hover:bg-[rgb(228,228,228)] hover:text-[rgb(42,42,42)] border border-[rgb(228,228,228)]">
      <button class="w-full">
    ...
    <li
      class="px-auto block cursor-pointer rounded-xl py-[20px] text-[25px] text-[white]
      hover:bg-[rgb(228,228,228)] hover:text-[rgb(42,42,42)] border border-[rgb(228,228,228)]" id="cerrar-menu">
        <button class="w-full">
